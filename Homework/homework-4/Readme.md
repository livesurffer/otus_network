...
#### Задачи:
- ###### Настройка Underlay сети на основе протоколов iBGP.
...
## Конфигурация:
[brm-leaf-001](https://github.com/livesurffer/otus_network/blob/main/Homework/homework-4/config/brm-leaf-001.conf)
```
...
[brm-leaf-002](https://github.com/livesurffer/otus_network/blob/main/Homework/homework-4/config/brm-leaf-002.conf)
```
...
```
[brm-leaf-003](https://github.com/livesurffer/otus_network/blob/main/Homework/homework-4/config/brm-leaf-003.conf)
```
...
[brm-spn-001](https://github.com/livesurffer/otus_network/blob/main/Homework/homework-4/config/brm-spn-001.conf)
```
...
Neighbor Status Codes: m - Under maintenance
  ...
  10.1.0.1         4  65001            642       642    0    0 10:37:43 Estab   1      1
  10.1.0.2         4  65001             25        25    0    0 00:20:35 Estab   1      1
  10.1.0.3         4  65001            642       642    0    0 10:37:21 Estab   1      1
```

- brm-spn-002:
```
brm-spn-002#sh ip bgp summary
BGP summary information for VRF default
Router identifier 10.0.1.2, local AS number 65001
Neighbor Status Codes: m - Under maintenance
  Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  10.1.0.1         4  65001            645       645    0    0 10:40:08 Estab   1      1
  10.1.0.2         4  65001             26        26    0    0 00:21:34 Estab   1      1
  10.1.0.3         4  65001            647       647    0    0 10:42:03 Estab   1      1
```
